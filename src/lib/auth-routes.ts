 ...
 * @example
 * ```ts
 * import { stripLocale } from "@docimin/utils"
 *
 ...
 * @example
 * ```ts
 * import { getBasePath } from "@docimin/utils"
 *
 ...
 * @example
 * ```ts
 * import { isRouteType } from "@docimin/utils"
 *
 ...
 * @example
 * ```ts
 * import { isPublicRoute } from "@docimin/utils"
 *
 ...
 * @example
 * ```ts
 * import { isGuestRoute } from "@docimin/utils"
 *
 ...
 * @example
 * ```ts
 * import { isProtectedRoute } from "@docimin/utils"
 *
